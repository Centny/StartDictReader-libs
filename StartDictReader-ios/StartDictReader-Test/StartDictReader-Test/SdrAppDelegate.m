...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	StartDictReader *reader = [[StartDictReader alloc]initWithPath:[NSString stringWithFormat:@"%@/stardict-langdao-ec-gb-2.4.2", [self DocumentDirectory]] name:@"langdao-ec-gb"];
